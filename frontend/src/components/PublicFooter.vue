<template>
  <footer class="bg-gray-900 text-gray-300 mt-16">
    <div class="container mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div>
        <p class="text-xs uppercase tracking-wider text-gray-500 font-semibold mb-3">Product</p>
      ...
      <div>
        <p class="text-xs uppercase tracking-wider text-gray-500 font-semibold mb-3">Company</p>
        <ul class="space-y-2 text-sm">
          <li><router-link to="/about" class="hover:text-white">About</router-link></li>
          <li><a href="mailto:hello@arcagenthub.example" class="hover:text-white">Contact</a></li>
        </ul>
      </div>

      <div>
        <p class="text-xs uppercase tracking-wider text-gray-500 font-semibold mb-3">Legal</p>
        <ul class="space-y-2 text-sm">
    ...
    <div class="border-t border-white/10">
      <div class="container mx-auto px-6 py-5 flex flex-col md:flex-row items-center justify-between text-xs text-gray-500 gap-2">
        <p>© {{ year }} ArcAgent Hub. All rights reserved.</p>
        <p>
          Settlement layer:
