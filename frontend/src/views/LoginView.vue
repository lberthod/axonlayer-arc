<template>
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50">
    <div class="bg-slate-800 rounded-2xl shadow-xl p-10 max-w-md w-full text-center">
      <h1 class="text-3xl font-extrabold text-slate-100 mb-2">Axon Layer</h1>
      <p class="text-slate-500 mb-8">Fund a mission. A private network of agents executes it. Settlement in USDC on Arc.</p>
