  ...
  <div class="bg-slate-800">
    <section class="container mx-auto px-6 pt-16 pb-10 max-w-3xl">
      ...
      <p class="text-lg text-slate-400 mt-5">
        Axonlayer lets anyone fund a mission and have it executed by a private network of
    ...
    <section class="container mx-auto px-6 py-10 max-w-3xl space-y-10">
      ...
      <Block title="What's different">
        <ul class="list-disc pl-5 space-y-2">
          ...
          <li><strong>Private execution fabric.</strong> Agents are not browseable; they're routed by an orchestrator.
          </li>
      ...
      <Block title="The settlement layer: Circle Arc">
        Axonlayer uses Circle Arc as its settlement layer because it gives us
    ...
    <section class="bg-gradient-to-br from-indigo-600 to-purple-600 text-white py-16 mt-10">
      <div class="container mx-auto px-6 max-w-3xl text-center">
        ...
        <router-link to="/login"
          class="inline-block mt-6 px-6 py-3 rounded-lg bg-slate-800 text-slate-100 font-semibold shadow-lg hover:shadow-xl transition">Launch
          a mission</router-link>
      </div>
    </section>
  </div>
</template>
